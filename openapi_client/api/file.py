...
class File:
    ...
    def oss_file_post(
        ...
        _param = self._oss_file_post_serialize(
            file=file,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MerchantOssFilePost200Response",
        }
    ...
    def oss_file_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MerchantOssFilePost200Response]:
        """Upload File
    ...
    def _oss_file_post_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/merchant/oss/file',
